...
function ToneCard({
  ...
  return (
    <button
      onClick={onSelect}
      className={`flex flex-col items-center justify-center gap-1.5 rounded-[16px] py-3 px-2 border transition w-full min-h-[100px]
      ${selected
          ? "bg-[#E8956D] text-white shadow-md border-[#E8956D]"
          : "bg-[#FAD8C7] border-[#E8956D] text-[#4A352F]"
        }`}
    >
...
export default function OnboardingPage() {
  ...
  return (
    <div className="bg-[#FCF5F0] min-h-screen flex items-center justify-center p-6 font-sans">
      <div className="bg-white border border-[#E8956D] rounded-[24px] w-full max-w-[800px] shadow-sm px-8 md:px-16 pt-10 pb-10">
          ...
          <div className="max-w-[600px] mx-auto w-full">
            ...
            <div className="w-full mb-5">
              ...
              <input
                ...
                className="w-full h-[48px] px-4 rounded-[12px] bg-[#FAD8C7] border border-[#E8956D] outline-none text-[#4A352F] text-[16px] placeholder-[#4A352F]/50"
              />
              {errors.name && (
            ...
            <div className="w-full mb-5">
              ...
              <div className="w-full px-4 py-3 rounded-[12px] bg-[#FAD8C7] border border-[#E8956D] flex items-center gap-4">
                <AgeSelector
                  value={ageMonths}
                  onChange={(v) => {
                    setAgeMonths(v);
            ...
            <div className="flex justify-center pt-2 pb-0">
              <button
                ...
                className="w-full max-w-[360px] h-[52px] bg-[#E8956D] hover:bg-[#D67F54] transition text-white text-[18px] font-bold rounded-[16px]"
              >
                Continue
              </button>
            </div>
        ...
        {step === 2 && (
          <div className="flex flex-col items-center justify-center text-center max-w-[500px] mx-auto py-6">
            ...
            <p className="mb-10 text-[#9E7E7A] text-[16px]">
